...
#
# Generated by export_simulation on Wed Jan 27 06:19:43 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './design_ufcache.sh' script.

./design_ufcache.sh -reset_run
...
./design_ufcache.sh -noclean_files

For more information on the script, please type './design_ufcache.sh -help'.
